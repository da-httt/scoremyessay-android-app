package com.example.scoremyessay.ui.main.fragment.showEssay.waitingEssay
...
import com.example.scoremyessay.databinding.FragmentViewEssayWaitingBinding
...
class WaitingEssayFragment : BaseFragmentWithViewBinding<FragmentViewEssayWaitingBinding>() {
    ...
    private fun initObserver(){
        viewModel.allEssay.observe(requireActivity(), {
            val listDoneEssay = it.filter { item ->
                item.status_id == Const.STATUS_WAITING}
    ...
    private fun initView() {
        ...
        binding.recyclerViewWaitingEssay.apply {
    ...
    ): FragmentViewEssayWaitingBinding = FragmentViewEssayWaitingBinding.inflate(inflater,container, false)
}